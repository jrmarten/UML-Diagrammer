...
public class SaveTemplateAction extends SaveFileAction
{
	...
	public void actionPerformed(ActionEvent e) {
		oldFocusOwner = SwingUtilities.getWindowAncestor(getActiveView().getComponent()).getFocusOwner();
		
		String filename = UMLApplicationModel.prompt("file.saveTemplate.prompt",
				"Save Template");
				...
				protected void failed(Throwable value) {
					...
					JSheet.showMessageSheet(
							...
							"<html>"
									...
									+ "<b>"
									+ labels.getFormatted("file.save.couldntSave.message",
