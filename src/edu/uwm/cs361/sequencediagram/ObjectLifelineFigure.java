...
public class ObjectLifelineFigure extends GraphicalCompositeFigure {
    ...
    private static class NameAdapter extends FigureAdapter {
        ...
        private ObjectLifelineFigure target;

        public NameAdapter(ObjectLifelineFigure target) {
            this.target = target;
        }
    ...
    @Override
    public ObjectLifelineFigure clone() {
        ObjectLifelineFigure that = (ObjectLifelineFigure) super.clone();
