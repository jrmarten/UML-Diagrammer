...
public class UMLApplicationModel extends DefaultApplicationModel
{
	...
	{
		if ( sharedEditor == null ) sharedEditor = new UMLDrawingEditor ( );
		return sharedEditor;
	}
	...
	private void addCreationButtonsTo ( JToolBar tb, final DrawingEditor edit )
	{
		...
		attributes.put ( AttributeKeys.STROKE_COLOR, Color.black );
		attributes.put ( AttributeKeys.TEXT_COLOR, Color.black );
		ButtonFactory.addToolTo ( tb, edit, new CreationTool (
				new LifelineFigure ( ), attributes ), "edit.createLifeline", labels );
