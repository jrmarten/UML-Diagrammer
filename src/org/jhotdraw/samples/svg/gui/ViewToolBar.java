	...
	protected JComponent createDisclosedComponent(int state) {
		...
		switch (state) {
			...
			case 2: {
				...
				gridSizeField.setHorizontalAlignment(SwingConstants.RIGHT);
				...
				gridSizeField.setHorizontalAlignment(SwingConstants.LEADING);
				...
				scaleFactorField.setHorizontalAlignment(SwingConstants.RIGHT);
				...
				scaleFactorField.setHorizontalAlignment(SwingConstants.LEADING);
