	...
	protected JComponent createDisclosedComponent(int state) {
		...
		switch (state) {
			case 1: {
				...
				faceField.setHorizontalAlignment(SwingConstants.RIGHT);
				...
				faceField.setHorizontalAlignment(SwingConstants.LEADING);
				...
				sizeField.setHorizontalAlignment(SwingConstants.LEADING);
				...
				JAttributeSlider sizeSlider = new JAttributeSlider(SwingConstants.VERTICAL, 0, 100, 12);
