	...
	protected JComponent createDisclosedComponent(int state) {
		...
		switch (state) {
			case 1: {
				...
				JAttributeSlider opacitySlider = new JAttributeSlider(SwingConstants.VERTICAL, 0, 100, 100);
				...
				widthField.setHorizontalAlignment(SwingConstants.LEADING);
				...
				heightField.setHorizontalAlignment(SwingConstants.LEADING);
			...
			case 2: {
				...
				colorField.setHorizontalAlignment(SwingConstants.LEFT);
				...
				opacityField.setHorizontalAlignment(SwingConstants.RIGHT);
				...
				opacityField.setHorizontalAlignment(SwingConstants.LEADING);
