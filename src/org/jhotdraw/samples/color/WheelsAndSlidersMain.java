...
public class WheelsAndSlidersMain extends javax.swing.JPanel {
	...
	public WheelsAndSlidersMain() {
		...
		chooserPanel.add(createColorWheelChooser(ColorSpace.getInstance(ColorSpace.CS_LINEAR_RGB),0,1,2,JColorWheel.Type.SQUARE));
		chooserPanel.add(createColorWheelChooser(ColorSpace.getInstance(ColorSpace.CS_CIEXYZ),1,0,2,JColorWheel.Type.SQUARE));
		chooserPanel.add(createColorWheelChooser(ColorSpace.getInstance(ColorSpace.CS_PYCC),1,2,0,JColorWheel.Type.SQUARE));
		chooserPanel.add(new JPanel());
		chooserPanel.add(createColorWheelChooser(ColorSpace.getInstance(ColorSpace.CS_sRGB),0,1,2,JColorWheel.Type.SQUARE));
	...
	private JPanel createSliderChooser(ColorSpace sys, boolean vertical) {
		...
		for (int i = 0;
				...
				i++) {
					JSlider s = new JSlider(SwingConstants.HORIZONTAL);
					s.setMajorTickSpacing(50);
					s.setPaintTicks(true);
					s.setOrientation(vertical ? SwingConstants.VERTICAL : SwingConstants.HORIZONTAL);
