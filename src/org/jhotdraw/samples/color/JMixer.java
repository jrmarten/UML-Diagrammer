...
public class JMixer extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		customHueField.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		analogousField.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		primaryField.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		clashField.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		triadField.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		splitField.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		complementaryField.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		achromaticField.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		monochromaticField.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		saturationSlider.setOrientation(SwingConstants.VERTICAL);
		gridBagConstraints = new java.awt.GridBagConstraints();
