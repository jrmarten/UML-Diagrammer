...
implements UIResource {
	...
	private void initComponents() {
		...
		hueField.setHorizontalAlignment(SwingConstants.TRAILING);
		hueField.setText("0");
		...
		saturationField.setHorizontalAlignment(SwingConstants.TRAILING);
		...
		brightnessField.setHorizontalAlignment(SwingConstants.TRAILING);
