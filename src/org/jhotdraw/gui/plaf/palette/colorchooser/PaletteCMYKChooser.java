...
implements UIResource {
	...
	private void initComponents() {
		...
		cyanField.setHorizontalAlignment(SwingConstants.TRAILING);
		cyanField.setText("0");
		...
		magentaField.setHorizontalAlignment(SwingConstants.TRAILING);
		...
		yellowField.setHorizontalAlignment(SwingConstants.TRAILING);
		...
		blackField.setHorizontalAlignment(SwingConstants.TRAILING);
