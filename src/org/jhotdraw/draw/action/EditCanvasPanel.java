...
public class EditCanvasPanel extends javax.swing.JPanel {
	...
	public EditCanvasPanel() {
		...
		opacitySlider = new JAttributeSlider(SwingConstants.VERTICAL, 0, 100, 100);
	...
	private void colorButtonPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_colorButtonPerformed
		if (drawing != null) {
			getColorChooser();
			Color color = JColorChooser.showDialog(this, labels.getString("attribute.backgroundColor"),
